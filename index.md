...
作成者：佐藤浩輔([@cos135](https://twitter.com/cosine_135))
...
+ 情報学の登場
    ...
    + ウィーナー(N. Wiener)：『サイバネティクス _Cybernetics_』(1948)
    + シャノン(C.E. Shannnon)：『通信の数学的理論 _A Mathematical Theory of Communication_』(1949)
    + コンピュータのアナロジー：
...
+ 認知心理学の先駆け
    + 1956年
        + G.A. ミュラー(G.A. Muller)：マジックナンバー7±2
